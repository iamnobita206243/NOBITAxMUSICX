...
MUST_JOIN_1 = "NOB1TA_SUPPORT"
MUST_JOIN_2 = "KNIGHT_CODER_01"
...
async def must_join_channels(app: Client, msg: Message):
    ...
    try:
        try:
            ...
            await send_join_message(msg, link1, "NOB1TA_SUPPORT")

        try:
            await app.get_chat_member(MUST_JOIN_2, msg.from_user.id)
        except UserNotParticipant:
            link2 = f"https://t.me/{MUST_JOIN_2}"
            await send_join_message(msg, link2, "KNIGHT_CODER_01")
