...
ASSUSERNAME = getenv("ASSUSERNAME" , "@NOB1TA_X_ASSISTANT")
...
API_KEY = getenv("API_KEY", '30DxNexGenBotsc72101')
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/iamnobita206243/NOBITAxMUSICX",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/vpcez6.jpg")
